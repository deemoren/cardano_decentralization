...
class Api(BaseApi):
    ...
    # pool_owner 的delegation amount历史
        ...
        # 转换数据类型
        pool_pledge_amount_delegation["pledge_amount"] = pool_pledge_amount_delegation["pledge_amount"].astype('float')
        pool_pledge_amount_delegation["pool_amount"] = pool_pledge_amount_delegation["pool_amount"].astype('float')
        pool_pledge_amount_delegation["delegation_amount"] = pool_pledge_amount_delegation["delegation_amount"].astype('float')
        pool_pledge_amount_delegation.insert(pool_pledge_amount_delegation.shape[1], 'leverage', 0)
        pool_pledge_amount_delegation["leverage"] =   pool_pledge_amount_delegation.apply(lambda y: (
        ...
        result = pool_pledge_amount_delegation.to_json(orient="records")
